    ...
    return (
        <>
            <div className="flex relative bg-[url('../../public/bg.svg')] w-[400px] h-[785px] justify-center items-center flex-col">
                ...
                <div className="bg-[url('../../public/photo-lg-1.svg')] w-[152px] h-[153px] flex absolute top-32"></div>
                <div className="flex items-center justify-center">
                    ...
                    <div className="flex items-center justify-center">
                        <div className="bg-[url('../../public/icon-camera.svg')] w-[24px] h-[24px] flex absolute bottom-[192px] right-10 z-10 cursor-pointer"></div>
                    ...
                    <Link to='/lista' className="bg-[url('../../public/btn-update.svg')] w-[360px] h-[50px] flex absolute bottom-8"></Link>
                </div>
            </div>
        </>
    )
